    ...
    .default([
      {
        ...
        answer:
          "With a free strategy call, then a short paid discovery sprint (1-2 weeks). You get a scoped roadmap, an architecture proposal, and a fixed quote for the first release. It's yours whether or not you build it with us.",
      },
      {
