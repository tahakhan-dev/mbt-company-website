...
| A-006 | Portfolio screenshots ×22 (11 products, hero+mid webp) + raw PNGs | Captured from official product sites (scripts/capture-portfolio.mjs) | Playwright capture | — | Owner-directed use of own products' marketing sites (2026-09-01 mandate); footer credits "product screenshots belong to their respective products" | Product owners / Aigenvora per owner claim | Owner-asserted | /work index + case pages + home strip | 2026-09-01 | local /media/portfolio | per-product interface alt text | portfolio.ts |
| A-007 | Clash Display variable webfont | Fontshare direct download | Indian Type Foundry | — | ITF FFL v2.0 (docs/licenses/ClashDisplay-FFL.txt) | ITF (licensed) | n/a | Display typography site-wide | 2026-09-01 | self-hosted /fonts | — | tokens.css |
